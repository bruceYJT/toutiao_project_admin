      ...
      <el-form ref='publish-form' :model="article" label-width="70px" :rules='formRules'>
        ...
        <el-form-item label="封面">
          ...
          <template v-if="article.cover.type > 0">
            <el-row :gutter='20'>
              <el-col :span='5' v-for="(item,index) in article.cover.type" :key="index">
                <uploadImg v-model="article.cover.images[index]"></uploadImg>
              </el-col>
            </el-row>
          </template>
        </el-form-item>
...
<script>
import { getArticleChannels, addArticle, getArticle, updateArticle, uploadImage } from '@/api/article'
import {
  ElementTiptap,
  Doc,
  Text,
